# Light ActivityPub Server PHP

[This page in English.](README.md)

Une implémentation légère de ActivityPub Server2Server et Server2Cient en PHP pour connecter un site web à Fediverse.

Voir [FEDERATION.md](FEDERATION.md) pour les détails de l'implémentation.

Voir [INSTALL.md](INSTALL.md) si vous voulez l'utiliser quelque part.
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/Light-ActivityPub-Server-PHP).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Light-ActivityPub-Server-PHP/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Light-ActivityPub-Server-PHP) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Light-ActivityPub-Server-PHP/issues).
